    ...
    <div class="app-main__inner">
        ...
        <div class="tabs-animation">
            <div class="mb-3 card element-block-example">
                <div class="card-body">
            <h5 class="card-title">Edit Board of Trustee</h5>
            <div class="col-md-12 col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" id="submit-bot-form" action="/EditBoardofTrustee/{{ $boards->id }}">
                            @csrf
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="botname" id="botname" type="text" class="form-control" value="{{ $boards->name}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="examplePassword22">Position/Delegation</label>
                                                <input name="botpos" id="botpos" type="text" class="form-control" value="{{ $boards->position}}">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="position-relative form-group">
                                        ...
                                        <img src="/storage/board/{{ $boards->image }}" width="100" height="100" />
                                    </div>
                                        ...
                                        <div class="card">
                                            ...
                                            <div data-parent="#accordion" id="collapseTwo"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <textarea name="content" id="editor">{{ $boards->about }}</textarea>
                                ...
                                <div id="step-32">
                                    <div class="no-results">
                                        ...
                                        <div class="text-center">
                                            <button class="btn-shadow btn-wide btn btn-success btn-lg" name="submit-bot" id="submit-bot">Update Board Of Trustee</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $("#submit-bot").click(function(e) {
           ...
           // const myForm = $('form#submit-bot-form');
               ...
               $.ajax({
                    url: "/EditBoardofTrustee/{{ $boards->id }}",
                    data: fd,
                    type: 'POST',
