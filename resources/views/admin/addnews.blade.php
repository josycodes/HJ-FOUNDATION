        ...
        <div class="tabs-animation">
            ...
            <div class="col-md-12 col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" id="submit-news-form" action="{{ route('CreateNews') }}">
                            @csrf
                            ...
                            <div class="form-wizard-content">
                                <div id="step-12">
                                    <div class="form-row">
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                ...
                                                <input name="newstitle" id="newstitle" type="text" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="position-relative form-group">
                                                <label for="examplePassword22">News Category</label>
                                                <input name="newscat" id="newscat" type="text" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="position-relative form-group">
                                        ...
                                        <input name="newsimage" id="newsimage" type="file" class="form-control-file @error('title') is-invalid @enderror" onchange="PreviewFile(this)">
                                        <br />
                                        @error('title')
                                ...
                                <div id="step-32">
                                    <div class="no-results">
                                        ...
                                        <div class="text-center">
                                            <button class="btn-shadow btn-wide btn btn-success btn-lg" name="submit-news" id="submit-news">Create News</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
